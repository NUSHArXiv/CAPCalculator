...
class MyTableViewAdapter : AbstractTableAdapter<ColumnHeader?, RowHeader?, Cell?>() {
    ...
    internal inner class MyCellViewHolder(itemView: View) : AbstractViewHolder(itemView) {
        ...
        init {
            cell_container = itemView.findViewById(R.id.table)
     ...
     */
    fun onBindCellViewHolder(holder: AbstractViewHolder, cellItemModel: Any, columnPosition: Int, rowPosition: Int) {
        val cell = cellItemModel as Cell

        // Get the holder to update cell item text
        val viewHolder = holder as MyCellViewHolder
        viewHolder.cell_textview.setText(cell.data.toString())
     ...
     */
    fun onBindColumnHeaderViewHolder(holder: AbstractViewHolder, columnHeaderItemModel: Any, position: Int) {
        val columnHeader = columnHeaderItemModel as ColumnHeader

        // Get the holder to update cell item text
        val columnHeaderViewHolder = holder as MyColumnHeaderViewHolder
        columnHeaderViewHolder.column_header_textview.setText(columnHeader.data)

        // If your TableView should have auto resize for cells & columns.
        // Then you should consider the below lines. Otherwise, you can ignore them.

        // It is necessary to remeasure itself.
        columnHeaderViewHolder.column_header_container.layoutParams.width = LinearLayout.LayoutParams.WRAP_CONTENT
     ...
     */
    fun onBindRowHeaderViewHolder(holder: AbstractViewHolder, rowHeaderItemModel: Any, position: Int) {
        val rowHeader = rowHeaderItemModel as RowHeader

        // Get the holder to update row header item text
        val rowHeaderViewHolder = holder as MyRowHeaderViewHolder
        rowHeaderViewHolder.row_header_textview.setText(rowHeader.data)
    }
